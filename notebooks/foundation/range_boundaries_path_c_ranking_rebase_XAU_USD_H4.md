...
## Acceptance Snapshot
- Selected/reporting rung: `step8e_b/mid_e`
- Contract-selected rung: `step8e_b/mid_e`
- Long-lived vs short-lived final strength gate passed: `True`
- Coverage stable: confirmed=`189`, active_rows=`1114`