...
def adx(
    ...
    *,
    ...
    """Average Directional Index using Wilder's RMA (matches TradingView).
    ...
    atr_val = atr(high, low, close, p)
    smooth_plus = _rma(plus_dm, p)
    smooth_minus = _rma(minus_dm, p)

    # +DI / -DI
    plus_di = 100 * smooth_plus / atr_val
    minus_di = 100 * smooth_minus / atr_val

    # DX → ADX (also Wilder-smoothed)
