...
class TestTrend:
    def test_add_emas_columns(self, sample_df):
        from src.indicators.trend import add_emas
    ...
    def test_add_adx_columns(self, sample_df):
        from src.indicators.trend import add_adx
...
class TestMomentum:
    ...
    def test_add_macd(self, sample_df):
        from src.indicators.momentum import add_macd
    ...
    def test_rsi_divergence(self, sample_df):
        from src.indicators.trend import add_swings
        from src.indicators.momentum import add_rsi, add_rsi_divergence
...
class TestVolatility:
    ...
    def test_add_bb_width(self, sample_df):
        from src.indicators.volatility import add_bb_width
    ...
    def test_add_body_ratio(self, sample_df):
        from src.indicators.volatility import add_body_ratio
    ...
    def test_rolling_atr_ratio(self, sample_df):
        from src.indicators.volatility import add_rolling_atr_ratio
...
class TestVolume:
    def test_add_volume_ratio(self, sample_df):
        from src.indicators.volume import add_volume_ratio
    ...
    def test_add_vsa(self, sample_df):
        from src.indicators.volume import add_vsa
    ...
    def test_add_wick_ratio(self, sample_df):
        from src.indicators.volume import add_wick_ratio
...
class TestValue:
    def test_prev_day_hl(self, intraday_df):
        from src.indicators.value import add_prev_day_hl
    ...
    def test_prev_week_hl(self, intraday_df):
        from src.indicators.value import add_prev_week_hl
    ...
    def test_round_number(self, sample_df):
        from src.indicators.volatility import add_atr
        from src.indicators.value import add_round_number_flag
    ...
    def test_asian_session_hl(self, intraday_df):
        from src.indicators.value import add_asian_session_hl
...
class TestVolumeProfile:
    ...
    def test_add_volume_profile(self, sample_df):
        from src.indicators.volatility import add_atr
        from src.indicators.volume_profile import add_volume_profile
...
class TestSession:
    def test_session_classifier(self, intraday_df):
        from src.indicators.session import add_session_classifier
    ...
    def test_time_features(self, sample_df):
        from src.indicators.session import add_time_features
...
class TestRegime:
    def test_add_regime(self, sample_df):
        from src.indicators.trend import add_emas, add_adx, add_swings, add_trend_state
        from src.indicators.volatility import add_bb_width
